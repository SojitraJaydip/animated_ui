...
class ScrollableExhibitionSheet extends StatefulWidget {
  @override
  _ScrollableExhibitionSheetState createState() => _ScrollableExhibitionSheetState();
}
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    ...events.map((event) {
                      ...
                      double widthPerElement = 40 + percentage * 80 + 8 * (1 - percentage);
                      double leftOffset = widthPerElement * (index > 4 ? index + 2 : index) * (1 - scaledPercentage);
                      return Positioned(
                        top: 44.0 + scaledPercentage * (128 - 44) + index * heightPerElement * scaledPercentage,
                        left: leftOffset,
                        right: 32 - leftOffset,
                        child: IgnorePointer(
                          ignoring: true,
                    ...
                    SheetHeader(
                      ...
                      topMargin: 16 + percentage * MediaQuery.of(context).padding.top,
                    ),
                    MenuButton(),
                  ],
                ),
...
class MyEventItem extends StatelessWidget {
  ...
  const MyEventItem({Key? key, this.event, this.percentageCompleted}) : super(key: key);
...
class SheetHeader extends StatelessWidget {
  ...
  const SheetHeader({Key? key, this.fontSize, this.topMargin}) : super(key: key);
